...
import { Dimensions, FlatList, I18nManager, Keyboard, Modal, Pressable, StatusBar, StyleSheet, Text, TouchableHighlight, TouchableWithoutFeedback, View } from "react-native";
  ...
  const _renderList = useCallback(isTopPosition => {
    ...
    const _renderListHelper = () => {
      return /*#__PURE__*/_jsx(FlatList, {
        ...
        ref: refList,
        initialScrollIndex: scrollToIndex > -1 && listData?.length > 4 ? scrollToIndex : undefined,
